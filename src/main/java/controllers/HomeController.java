...
public class HomeController {
  ...
  public void setPersonService(productServices ps){
    ...
    @RequestMapping(value="/productTableUsers/{category}")                                                  //mod
    public ModelAndView showproductTableUsers(@PathVariable("category") String category)
	{
		 //listtojsp=new ArrayList<Product>();
		 List<Product> listtojsp=productService.listProductByCategory(category);
		System.out.println(listtojsp.isEmpty());
  ...
  //json productTableUsers
    ...
    public String saveProduct(@ModelAttribute Product contact){
...
@RequestMapping("/login")
  ...
  public String showProducts(@ModelAttribute ("product") Product p,Model model){
  ...
  public String doSendEmail(HttpServletRequest request) {
      ...
      String subject ="MobiQue :: Your Friend Recommends..."+request.getParameter("mobique alert");
